...
export default async function Page(){
 ...
 const {data:templatesData,error}=await s.from("templates").select("id,name,slug,category,price,is_published,created_at").order("created_at",{ascending:false});
 if(error) console.warn("Supabase templates query error:", error.message);
